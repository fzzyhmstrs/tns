    ...
    override fun lootBuilder(id: Identifier, table: LootTable.Builder): Boolean{
        if(LootTables.WOODLAND_MANSION_CHEST.equals(id) || LootTables.PILLAGER_OUTPOST_CHEST.equals(id) || LootTables.SIMPLE_DUNGEON_CHEST.equals(id) || LootTables.VILLAGE_FLETCHER_CHEST.equals(id) || LootTables.DESERT_PYRAMID_CHEST.equals(id) || LootTables.ABANDONED_MINESHAFT_CHEST.equals(id)){
            val poolBuilder = LootPool.builder()
                ...
                .with(ItemEntry.builder(RegisterItem.BONE_HARPOON).weight(5).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(2f,6f))))
                .with(ItemEntry.builder(RegisterItem.PRISMARINE_HARPOON).weight(1).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1f,4f))))
            ...
            val poolBuilder = LootPool.builder()
                ...
                .with(ItemEntry.builder(RegisterItem.PRISMARINE_HARPOON).weight(1).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(2f,8f))))
            table.pool(poolBuilder)
            return true
            ...
            val poolBuilder = LootPool.builder()
                ...
                .with(ItemEntry.builder(RegisterItem.PRISMARINE_HARPOON).weight(5).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(2f,6f))))
                .with(ItemEntry.builder(RegisterItem.DIAMOND_HARPOON).weight(1).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1f,4f))))
            table.pool(poolBuilder)
            return true
        }
